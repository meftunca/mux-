...
enum Code {
  ...
  NoContent =
      204,  //!< Indicates that the server has successfully fulfilled the
  ...
  Found =
      302,  //!< Indicates that the target resource resides temporarily under
            //!< a different URI.
  ...
  ContentTooLarge =
      413,  //!< Indicates that the server is refusing to process a
  ...
  //!< action failed.
  TooEarly =
      425,  //!< Indicates that the server is unwilling to risk processing
  ...
  PreconditionRequired =
      428,  //!< Indicates that the origin server requires the
            //!< request to be conditional.
  TooManyRequests =
      429,  //!< Indicates that the user has sent too many requests
